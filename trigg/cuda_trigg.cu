...
#define bsg2_0(x) (xor3b(ROTR32(x,2),ROTR32(x,13),ROTR32(x,22)))
#define bsg2_1(x) (xor3b(ROTR32(x,6),ROTR32(x,11),ROTR32(x,25)))
#define ssg2_0(x) (xor3b(ROTR32(x,7),ROTR32(x,18),(x>>3)))
#define ssg2_1(x) (xor3b(ROTR32(x,17),ROTR32(x,19),(x>>10)))
#define andor32(a,b,c) ((a&b) | ((a|b) & c))
...
{
    uint32_t t1,t2;
    t1 = h + bsg2_1(e) + xandx(e, f, g) + Kshared + in;
...
{
    uint32_t t1,t2;
    in[pc] = ssg2_1(in[(pc-2) & 0xF]) + in[(pc-7) & 0xF] + ssg2_0(in[(pc-15) & 0xF]) + in[pc];
